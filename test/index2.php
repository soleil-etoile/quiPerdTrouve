    ...
    <div class="col-md-8 col-xs-8">
        <div class="lienscentraux">
            <button type="button" class="btn btn-lg btn-danger btn-boutons">
                <a href="perdu.php" class="boutons" id="btn_perdu"><img src="images/logo/perdu_bouton.png" id="perdu" />J'ai perdu<br/> </a></button>
            <button type="button" class="btn btn-lg btn-warning btn-boutons">
                <a href="depotAnnonce.php" class="boutons">Je dépose<br/>une annonce</a></button><!--'i'm a rebel" ;)-->
