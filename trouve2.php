...
if(isset($_POST['btnSub']))
{
    ...
    if(isset($_POST['pays']) and $_POST['pays'] !== "")
    {
        ...
        if($page >1) echo '<li>
                                <a href="trouve2.php?page='.($page-1).'">Précedent</a>
                            </li>';
        ...
        for($i=1; $i<=$nbPages; $i++)
        {
            ...
            echo '<li '.$classe.'><a href="trouve2.php?page='.$i.'">'.$i.'</a></li> ';
        }

        if($page < $nbPages) echo '<li><a href="trouve2.php?page='.($page+1).'">Suivant</a></li>';
        echo '</ul>';
        ...
        else
        {
            ...
            foreach($listeObjets as $nb => $objet)
            {
                ...
                echo '<article class="col-md-2">
                        <a href="annonce_trouve.php?id_objet='.$objet['id_objet'].'" class="lien_annonce">
    ...
    else
    {
        ...
        echo '<a href="trouve.php" class="resultat">Merci d\'indiquer la localisation de la trouvaille</a>'; 
    }
