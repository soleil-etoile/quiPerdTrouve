...
?>
    <form class="form-horizontal" method="post" id="form" action="trouve2.php">
...
if($page >1) echo '<li>
                        <a href="trouve.php?page='.($page-1).'">Précedent</a>
                    </li>';
...
for($i=1; $i<=$nbPages; $i++)
{
    ...
    echo '<li '.$classe.'><a href="trouve.php?page='.$i.'">'.$i.'</a></li> ';
}

if($page < $nbPages) echo '<li><a href="trouve.php?page='.($page+1).'">Suivant</a></li>';
echo '</ul>';
